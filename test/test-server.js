...
describe('Shopping List', function () {
  ...
  it('should list items on GET', function () {
    ...
    return chai.request(app).get('/shopping-list').then(function (res) {
      ...
      var expectedKeys = ['id', 'name', 'checked'];
  ...
  it('should add an item on POST', function () {
    var newItem = { name: 'coffee', checked: false };
  ...
  it('should update items on PUT', function () {
    ...
    .get('/shopping-list').then(function (res) {
      ...
      return chai.request(app).put('/shopping-list/' + updateData.id).send(updateData);
    })
...
describe('Recipes', function () {
  ...
  it('should list items on GET', function () {
    ...
    return chai.request(app).get('/recipes').then(function (res) {
      ...
      // each item should be an object with key/value pairs
      // for `id`, `name` and `checked`.
      var expectedKeys = ['name', 'ingredients', 'id'];
      res.body.forEach(function (item) {
        item.should.be.a('object');
        item.should.include.keys(expectedKeys);
      });
  ...
  //  status code and that the returned object has an `id`
  it('should add an item on POST', function () {
    var newItem = { name: 'Chili Dog', ingredients: 'chili, hot dog, bun', id: 'testPOST' };
...
// recipe block 
  // test strategy:
  //  1. GET a Recipes items so we can get ID of one
  //  to delete.
  //  2. DELETE an item and ensure we get back a status 204
  it('should delete items on DELETE', function () {
    return chai.request(app)
